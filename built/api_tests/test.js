...
import { testGetUserAccount, } from './accounts';
const deleted = true;
...
describe('User Accounts Routes, Vendor account', testGetVendorAccount
    .bind(null, !deleted))
...
describe('User Accounts Routes, Customer account', testGetCustomerAccount
    .bind(null, !deleted))
