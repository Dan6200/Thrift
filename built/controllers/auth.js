...
const register = (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    let result = yield db.query('select user_id from marketplace.user_account'), lastInsert = result.rowCount - 1, newUser = result.rows[lastInsert], token = createToken(newUser.user_id);
