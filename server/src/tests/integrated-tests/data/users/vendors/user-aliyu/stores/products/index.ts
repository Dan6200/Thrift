...
export const products: Product[] = [
	{
		...
		description: [
			`* 1.69" HD Full Touch Screen: High texture watch frame with 1.69" LCD full touch colorful screen bring comfortable touch and excellent visual experience.
				There are various watch face styles to choose from in the app. Also you can choose a picture you like to customize the watch face in "QWatch Pro" App.
				And the smartwatch screen will light up every time you raise your hand.`,
...
export const productMedia = [
	{
		...
		path: '~/dev_work/thrift/server/src/tests/product-media/TOZO smartwatch/61s3bP9rdOL._AC_SL1500_.jpg',
		description: 'A smartwatch',
	},
	{
		name: 'TOZO SmartWatch',
		path: '~/dev_work/thrift/server/src/tests/product-media/TOZO smartwatch/71-QFdYVDjL._AC_SL1500_.jpg',
		description: 'A smartwatch',
	},
	{
		name: 'TOZO SmartWatch',
		path: '~/dev_work/thrift/server/src/tests/product-media/TOZO smartwatch/716xePAwIxL._AC_SL1500_.jpg',
		description: 'A smartwatch',
	},
	{
		name: 'TOZO SmartWatch',
		path: '~/dev_work/thrift/server/src/tests/product-media/TOZO smartwatch/71DWBxbq1NL._AC_SL1500_.jpg',
		description: 'A smartwatch',
	},
	{
		name: 'TOZO SmartWatch',
		path: '~/dev_work/thrift/server/src/tests/product-media/TOZO smartwatch/71MNIstzDvL._AC_SL1500_.jpg',
		description: 'A smartwatch',
	},
	{
		name: 'TOZO SmartWatch',
		path: '~/dev_work/thrift/server/src/tests/product-media/TOZO smartwatch/71UMkMp9d1L._AC_SL1500_.jpg:Zone.Identifier',
		description: 'A smartwatch',
	},
]
